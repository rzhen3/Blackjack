...
heart = pygame.image.load('Poker\heart.png').convert_alpha()
spade = pygame.image.load('Poker\spade.png').convert_alpha()
club = pygame.image.load('Poker\club.png').convert_alpha()
diamond = pygame.image.load('Poker\diamond.png').convert_alpha()
...
SlideM = pygame.image.load('Poker\Card Counting Guide.jpg').convert_alpha()
Slide0 = pygame.image.load('Poker\Card Counting Guide (1).jpg').convert_alpha()
Slide1 = pygame.image.load('Poker\Card Counting Guide (2).jpg').convert_alpha()
Slide2 = pygame.image.load('Poker\Card Counting Guide (3).jpg').convert_alpha()
Slide3 = pygame.image.load('Poker\Card Counting Guide (4).jpg').convert_alpha()
Slide5 = pygame.image.load('Poker\Card Counting Guide (5).jpg').convert_alpha()
Slide6 = pygame.image.load('Poker\Card Counting Guide (6).jpg').convert_alpha()
Slide7 = pygame.image.load('Poker\Card Counting Guide (7).jpg').convert_alpha()
Slide9 = pygame.image.load('Poker\Card Counting Guide (8).jpg').convert_alpha()
Slide10 = pygame.image.load('Poker\Card Counting Guide (9).jpg').convert_alpha()
Slide11 = pygame.image.load('Poker\Card Counting Guide (10).jpg').convert_alpha()
Slide12 = pygame.image.load('Poker\Card Counting Guide (11).jpg').convert_alpha()
Slide13 = pygame.image.load('Poker\Card Counting Guide (12).jpg').convert_alpha()
Slide14 = pygame.image.load('Poker\Card Counting Guide (13).jpg').convert_alpha()
Slide15 = pygame.image.load('Poker\Card Counting Guide (14).jpg').convert_alpha()
...
##
heart = pygame.image.load('Poker\heart.png').convert_alpha()##immages for the suits
spade = pygame.image.load('Poker\spade.png').convert_alpha()
club = pygame.image.load('Poker\club.png').convert_alpha()
diamond = pygame.image.load('Poker\diamond.png').convert_alpha()
