...
heart = pygame.image.load(r'Poker\heart.png').convert_alpha()
spade = pygame.image.load(r'Poker\spade.png').convert_alpha()
club = pygame.image.load(r'Poker\club.png').convert_alpha()
diamond = pygame.image.load(r'Poker\diamond.png').convert_alpha()
...
SlideM = pygame.image.load(r'Poker\BCCC.jpg')
Slide0 = pygame.image.load(r'Poker\Card Counting Guide.jpg')
Slide1 = pygame.image.load(r'Poker\Card Counting Guide (1).jpg').convert_alpha()
Slide2 = pygame.image.load(r'Poker\Card Counting Guide (2).jpg').convert_alpha()
Slide3 = pygame.image.load(r'Poker\Card Counting Guide (3).jpg').convert_alpha()
Slide4 = pygame.image.load(r'Poker\Card Counting Guide (4).jpg').convert_alpha()
Slide5 = pygame.image.load(r'Poker\Card Counting Guide (5).jpg').convert_alpha()
Slide6 = pygame.image.load(r'Poker\Card Counting Guide (6).jpg').convert_alpha()
Slide7 = pygame.image.load(r'Poker\Card Counting Guide (7).jpg').convert_alpha()
Slide8 = pygame.image.load(r'Poker\Card Counting Guide (8).jpg').convert_alpha()
Slide9 = pygame.image.load(r'Poker\Card Counting Guide (9).jpg').convert_alpha()
Slide10 = pygame.image.load(r'Poker\Card Counting Guide (10).jpg').convert_alpha()
Slide11 = pygame.image.load(r'Poker\Card Counting Guide (11).jpg').convert_alpha()
Slide12 = pygame.image.load(r'Poker\Card Counting Guide (12).jpg').convert_alpha()
Slide13 = pygame.image.load(r'Poker\Card Counting Guide (13).jpg').convert_alpha()
Slide14 = pygame.image.load(r'Poker\Card Counting Guide (14).jpg').convert_alpha()
Slide15 = pygame.image.load(r'Poker\Card Counting Guide (15).jpg').convert_alpha()
...
heart = pygame.image.load(r'Poker\heart.png').convert_alpha()##immages for the suits
spade = pygame.image.load(r'Poker\spade.png').convert_alpha()
club = pygame.image.load(r'Poker\club.png').convert_alpha()
diamond = pygame.image.load(r'Poker\diamond.png').convert_alpha()
...
class TextBox(pygame.sprite.Sprite):# class for inputing text
...
def betamount(truecount,money): #calculates the amount the user should bet
    ...
    if suggestion<=0:
        betamounttxt = bigfont.render("Suggested bet amount: Minimum bet($2)", True, (0, 0, 0))
    else:        
        betamounttxt = bigfont.render("Suggested bet amount: "+ str(suggestion), True, (0, 0, 0))
    win.blit(betamounttxt,(710,500))
      ...
      for e in pygame.event.get(): #has user add am amount to wager
        ...
        if e.type == pygame.KEYDOWN:
            ...
            if e.key == pygame.K_BACKSPACE:
                ...
                textBox.update()
            if e.key == pygame.K_RETURN: #when enter is hit the string is returned
                if usable_money < int(textBox.text) or textBox.text == "":
                    continue
                elif len(textBox.text) > 0:
                    print (textBox.text)
                    return textBox.text

def split(): ####################please don't repaire this# if your #####################################################################################################WIP
    money-=wager
    splithand1.append(user1cards[0])
    splithand2.append(user1cards[1])
    pygame.draw.rect(win,(255,255,255), (100,300,500,270))
    
    splithand1total = drawcard(splithand1[-1],player1locationsx[0] + 80 + 50,player1locationsy[0]+-30)
    splithand2total = drawcard(splithand2[-1],player1locationsx[0] - 50,player1locationsy[0]+-30)

    time.sleep(10)
    deal(splithand1)
    splithand1total += drawcard(splithand1[-1],player1locationsx[1] + 80 + 50,player1locationsy[1]-30)
    time.sleep(5)
...
while True: ###################first time using game settup#############
...
while True: #################################### main loop ######################### end of startup############################################3
    ...
    while True:#########################User clicks buttons
        ...
        #if user1cards[0][0] == user1cards[1][0]:
        #f   print("split")
            #split()
